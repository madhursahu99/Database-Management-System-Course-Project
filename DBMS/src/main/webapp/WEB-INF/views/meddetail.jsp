...
<div class="container text-center">
  <h7 class="display-4">Medicine Detail</h7>
   <hr class="my-4">
   </div>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text">Mfg. date : ${med.mfg_date}</p>
        <p class="card-text">Expiry Date : ${med.expiry_date}</p>
        <p class="card-text">Price : ${med.price}</p>
        
         <a class="btn btn-outline-info" data-toggle="collapse" href="#searchbyid" role="button" aria-expanded="false" aria-controls="collapseExample">
    				Add to cart
  			</a><br><br>
